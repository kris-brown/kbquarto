...
[Author](/docs/phil/people/Robert Brandom.html) [Prev](/docs/phil/antirep2020/04 -  Cheryl Misak's Critique of Rorty's Pragmatism.html) [Next](/docs/phil/antirep2020/06 - Rorty's Political Turn.html)
...
[^tde]: The appeal here is to Quine’s pragmatist arguments in [Two Dogmas of Empiricism](/docs/phil/works/Two Dogmas of Empiricism.html).


# RR on Romanticism
Mediating between idealism and pragmatism.

Romanticism has idealist and pragmatist tendencies. Idealism corresponds to [weak textualism](/docs/phil/quotes/Strong and weak textualists.html), while pragmatism to strong. The weak ones haven't freed themselves from Philosophy.

Rorty gives a [redescription of Nietzsche](/docs/phil/quotes/Pragmatism and Nietzsche.html), an example of the kind of strong textualism which takes a text and beats it into a shape to suit the reader's purpose, imposing his own vocabulary on it.

Rorty [reconstructs](/docs/phil/quotes/Hegel literary genre.html) a progression from *idealism* to *romanticism* to *pragmatism*.

Rorty makes a number of claims:

1. [all problems, topics, and distinctions are language-relative](/docs/phil/quotes/Textualists and language relativity.html)
2. [criticizing any philosophical view that presupposes an objectively privileged vocabulary (simply in virtue of its relation to its subject matter)](/docs/phil/quotes/Strong and weak textualists.html)
3. [the vocabulary of science is merely one among others](/docs/phil/quotes/Romanticism as vocabulary over truth.html)
...
Rorty classifies this claim of [Derrida](/docs/phil/people/Jaques Derrida.html) as "weak textualism" and sees it as backsliding into representationalist philosophy.

{{< include "/docs/phil/quotes/textualism as misleading.qmd" >}}


[^mcd]: Note that McDowell centrally claims "The conceptual has no outer boundary" in [Mind and World](/docs/phil/works/Mind and World.html)
...
[Sense dependence vs reference](/docs/phil/interaction/Sense dependence vs reference.html) is relevent: One is frightened of claims of vocabulary dependence because one is thinking of reference- dependence claims. What is arguable is sense-dependence.
...
{{< include "/docs/phil/quotes/grenzbegriff.qmd" >}}
