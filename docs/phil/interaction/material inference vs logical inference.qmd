...
listing:
  ...
  contents:
    - ../../../backlinks/material inference vs logical inference.yml
---

Let an *inference* be a statement with a [material conditional](/docs/phil/Material Conditional.html), i.e. of the 
...
[^2]: This demonstrates that this distinction is different from the [analytic/synthetic distinction](/docs/phil/interaction/Analytic and synthetic facts.html). 
