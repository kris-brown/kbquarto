...
# Conventional wisdom: desire <-> a desired state of the world
  ...
  - Challenging scenario for this view:
    - A man is rushing to catch a important train to NYC and boards at the last 
    ...
    - **No** - eliminitivist
      ...
      - Problem:
        - The doctor was going to tell him if his disease was curable, so what 
          his 'true' desire is the cure, not the train to NYC (this can be done 
          ad infinitum: his true desire is not the cure but rather health -> 
          happiness -> 'the good').
    ...
    - **Yes** - separatist
      ...
      - Problem
        - This account makes the desires seem separate/atomic, but why do they 
          seem so intimiately connected to each other?
...
# Relation between desire and belief
  - Conventional wisdom holds they are both representable merely as states of 
    ...
    - We want to update our belief state to match the world, want to update the 
      world to match our belief state.
...
# Summary slogan: "Satisfaction as a compromise"
  ...
  - These thoughts might inspire positive change in fields like economics, where 
    ...
    - Their framework involves setting up a system that optimizes utility, given 
      desires (as the fixed input data).
