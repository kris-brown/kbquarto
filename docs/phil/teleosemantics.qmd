...
listing:
  ...
  contents:
    - ../../backlinks/teleosemantics.yml
---

Developed by [Ruth Millikan](/docs/phil/people/Ruth Millikan.html).
...
The idea of teleosemantics is an evolutionary sort of [semantics](/docs/phil/Semantics.html).
