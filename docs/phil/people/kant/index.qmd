...
Kant transformed the Cartesian problematic from an *epistemic* one to a *semantic* one [-@brandom2006kantian].
...
- His problem is not "show that reality is often as it appears", but rather "understand what
it is for things so much as to appear to be one way rather than another."
