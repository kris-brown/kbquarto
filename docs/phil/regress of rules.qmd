...
listing:
  ...
  contents:
    - ../../backlinks/regress of rules.yml
---

To follow a [rule](/docs/phil/Rules.html) (e.g. 'under circumstances $C$, do $A$', or 'Whenever you see a cat, raise your arm'), we have to understand the concepts that are involved within (i.e. $C$ or *cat*, or *raising one's arm*).
