...
listing:
  ...
  contents:
    - ../../../backlinks/docs/phil/definitions/representation.yml
---

Representation is a theory of the relation between appearance and reality. 

# A successor notion to theories of resemblance
...
[Descartes](/docs/phil/people/descartes) came up with the more abstract 
meta-concept (which Kant would dub representation, or Vorstellung) as a new way 
of thinking of the relation between appearance and reality.

[Spinoza](/docs/phil/people/spinoza) saw Descartes' philosophy as being 
understood in terms of his innovations of relating algebra to geometry. How 
could strings of algebraic symbols be useful / veridical appearances of 
geometrical reality? 

- "The order and connection of things is the same as the order and 
  connection of ideas" ([2P7 doctrine](https://plato.stanford.edu/entries/spinoza-attributes/#N2P7Doct))
...
|       | [Empiricists](/docs/phil/schools/empiricism.qmd)  | [Rationalists](/docs/phil/schools/rationalism.qmd) |
| ----------------------------------- | -------------------------- |------------------------|
...
[^whole]: Rationalist [Leibniz](/docs/phil/people/leibniz) would have us understand the content of the map (*as* a representation) to be the inferences that someone who treats it as a map could make about terrain facts (e.g. a river) from map-facts (wavy-blue line).
...
[^sc]: Sellars identifies both camps as [descriptivists](/docs/phil/schools/descriptivism.qmd) (to be conceptually contentful is just to describe / represent how things are).

[^oe]: Rationalists take all our cognitively contentful expressions as therefore being part of the actual world, resulting in ontological extravagance (postulating objective values/universals/propositions/laws)
...
Kant saw Descartes as having made an advance by assimilating impressions and 
concepts as species under the genus of representation. But these 
categorically-different species 
play different roles in our capacity to know things (rather than being the same 
species but having a spectrum).