...
# Origins
From its own perspective, analytic philosophy was founded by Russell and Moore. It was rebelling against idealism, which culimated in [Hegel](/docs/phil/people/Georg Wilhelm Friedrich Hegel.html) and [F. H. Bradley](/docs/phil/people/F. H. Bradley.html). ([Kant](/docs/phil/people/Immanuel Kant.html) was also thrown out of the anglophone canon, which moved from Leibniz -> J.S. Mill -> Frege, skipping the German idealists).

However, Rorty claims in [Philosophy and the Mirror of Nature](/docs/phil/works/Philosophy and the Mirror of Nature.html) that analytic philosophy is a [neokantian](/docs/phil/Neokantianism.html) enterprise because it attempts to situate formal logic and philosophy of language as "first philosophy", as having a fundamental and ahistorical understanding of concepts / knowledge, such that it becomes the [queen of the sciences](/docs/phil/interaction/Relation of philosophy to other disciplines.html).
