...
\begin{tikzcd}Mngr \circlearrowright \underset{Employee}{\bullet}\arrow[rr, "WorksIn", bend left] \arrow[rd, "FName"'] &                        & \underset{Dept}{\bullet} \arrow[ll, "Secr"]\arrow[ld, "DName"] \\                                                                                                         & \overset{string}{\circ} &                                                                           \end{tikzcd}
