...
[Descartes](/docs/phil/people/René Descartes.html) came up with the more abstract meta-concept (which Kant would dub representation, or *Vorstellung*) as a new way of thinking of the relation between appearance and reality.

[Spinoza](/docs/phil/people/Baruch Spinoza.html) saw Descartes' philosophy as being understood in terms of his innovations of relating algebra to geometry. How could strings of algebraic symbols be useful / veridical appearances of 
geometrical reality? 
...
[^whole]: Rationalist [Leibniz](/docs/phil/people/Gottfried Wilhelm Leibniz.html) would have us understand the content of the map (*as* a representation) to be the inferences that someone who treats it as a map could make about terrain facts (e.g. a river) from map-facts (wavy-blue line).
