---
title: "04: Counterfactuals and the Kant-Sellars Thesis"
categories: 🔴
...
listing:
  ...
  contents:
    - /../../../../../../backlinks/docs/phil/people/brandom/sellars09/4/index.yml
---

# Counterfactuals and dispositions

Uses [Principia Mathematica](/docs/phil/people/russell/works/principia) 
notation, which takes some time to learn.

[Goodman](/docs/phil/people/goodman) has let the formalism of classical 
...
Goodman is impressed in 
[*Fact, Fiction, and Forecast*](/docs/phil/people/goodman/works/fff), with 
...
Sellars makes the 
[subjunctive vs counterfactual distinction](/docs/phil/distinctions/made/subjunctive_counterfactual.qmd).
...
An axial idea of [Kant](/docs/phil/people/kant): the framework that 
...
[Kant](/docs/phil/people/kant) is concerned with features that are 
...
[Kant](/docs/phil/people/kant) says concepts are rules for judgment we 
...
Sellars calls this [*descriptivism*](/docs/phil/definitions/descriptivism.qmd): 
what you do with language is describe things.

You find this not only in anglophone tradition but also in a pure form in 
[Hussurl](/docs/phil/people/hussurl) / semiotics. 
[Derrida](/docs/phil/people/derrida) rejects Hussurl because there are 
...
things with them. Theory of judgment. The 
[Tractatus](/docs/phil/people/wittgenstein/works/tractatus) has no 
room for statements 
...
1. Kripke's 
   [possible-worlds semantics](/docs/phil/definitions/possible_worlds.qmd) 
   for modal logic (algebraic properties 
...
2. The previous development is only for modal logic, but Montague, David Kaplan, 
   [David Lewis](/docs/phil/people/lewis), Stalnaker, etc. extended 
   it to work for non-logical semantics as well. See, for example, Lewis' 
   [*General Semantics*](/docs/phil/people/lewis/works/general_semantics.qmd)
3. Kripke's [*Naming and Necessity*](/docs/phil/people/kripke/works/naming_and_necessity)
...
are *not* 
[monotonic](/docs/phil/definitions/nonmonotonic_logic.qmd). The job of some 
...
# Relation to Hegel
[Hegel](/docs/phil/people/hegel) says, "By conceptual, I mean, what's 
...
[Phenomenology of Spirit](/docs/phil/people/hegel/works/spirit).
...
[David Lewis](/docs/phil/people/lewis) is presented as an example of 
