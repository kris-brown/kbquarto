...
[Author](/docs/phil/Robert Brandom.html) [Next](/docs/phil/02 - Inference and Meaning and Language Games (2009).html)
...
- Sellars' overall aim was to move analytic philosophy from its Humean phase to its Kantian phase.
  ...
  - That Kant was worth respecting a radical view at the time - he had been 
    written out of the canon due to his connection to [Hegel](/docs/phil/Georg Wilhelm Friedrich Hegel.html).
...
- Things like intentional, normative, metaphysical vocabularies were typically 
  ...
  - Core programs of empiricism and naturalism can be understood as having 
    ...
    - Naturalism: language of natural science (possibly just fundamental 
      physics or broader)
    - The Vienna Circle was divided into two wings. Schlict (empiricist) and [Otto Neurath](/docs/phil/Otto Neurath.html) 
...
[Counterfactuals, Dispositions, and the Causal Modalities](/docs/phil/Counterfactuals, Dispositions, and the Causal Modalities.html).
...
- E.g. "Looks $\phi$" talk depends on "Is $\phi$" talk. ([EPM](/docs/phil/Empiricism and the Philosophy of Mind.html))
...
- the empricial naturalism is epitomized by [Scienta mensura](/docs/phil/Scienta mensura.html) quote
