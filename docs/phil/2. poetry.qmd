...
[Elucidations](/docs/phil/Elucidations.html): [Prev](/docs/phil/1. Desire.html) [Next](/docs/phil/3. Nietzsche and Morality.html)

# What do we mean by poetry
- Clarification: "poetry" to [Plato](/docs/phil/Plato.html) is more similar to what we call theatre
...
- The effect of being exposed to poetry: one tries to be many things, instead of 
  one thing.
  - Background: Plato + [Aristotle](/docs/phil/Aristotle.html) 
