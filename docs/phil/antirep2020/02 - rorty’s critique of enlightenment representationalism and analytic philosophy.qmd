...
[Author](/docs/phil/people/Robert Brandom.html) [Prev](/docs/phil/antirep2020/01 - The Concept of Representation.html) [Next](/docs/phil/antirep2020/03 - Rorty Finds His Pragmatist Voice.html)

A discussion of [Philosophy and the Mirror of Nature](/docs/phil/works/Philosophy and the Mirror of Nature.html). Brandom views the core argument to be chapter 4, which this lecture focuses on.

# Rorty's basic idea
## Neokantianism vs a socialized/historicized/naturalized alternative

- Rorty redescribes the history of philosophy as a struggle over the [Relation of philosophy to other disciplines](/docs/phil/interaction/Relation of philosophy to other disciplines.html). Fought by two camps in the 19th century and then re-enacted in the 20th century.
  - **[Neokantianism](/docs/phil/Neokantianism.html)** Philosophy has sovereign authority over the high culture.
    - Idea originates with [Plato](/docs/phil/people/Plato.html), but Descartes / Kant /  representationalism are modern versions.
  - **Neohegelianism**/pragmatism ([Hegel](/docs/phil/people/Georg Wilhelm Friedrich Hegel.html) socialized philosophy, [Marx](/docs/phil/people/Karl Marx.html) naturalized it). Philosophy brought 'down to Earth'. The American pragmatists continued in this path.
- [Bertrand Russell](/docs/phil/people/Bertrand Russell.html) and [Husserl](/docs/phil/people/Edmund Husserl.html) found things for philosophy to be apodictic about. Basis of Rorty's 'astonishing' claim that [analytic philosophy](/docs/phil/Analytic philosophy.html) is just a phase of neokantianism
  ...
  - Husserl subject to Sellars' critique of the  [Myth of the Given](/docs/phil/Myth of the Given.html),  [Russell](/docs/phil/people/Bertrand Russell.html) subject to Quine's critique of the [Myth of the Museum](/docs/phil/Myth of the Museum.html).  ([Carnap](/docs/phil/people/Rudolf Carnap.html) is subject to both myths).
- Rorty regards the pragmatist/holist Quine+Sellars rebuttals as bringing us back to [Dewey](/docs/phil/people/John Dewey.html)'s socialized / historicized / naturalized philosophy.[^de]
...
- mentored by [C. I. Lewis](/docs/phil/people/C. I. Lewis.html) and hugely influenced by Carnap.
...
| Relevant work | [Empiricism and the Philosophy of Mind](/docs/phil/works/Empiricism and the Philosophy of Mind.html) | [Two Dogmas of Empiricism](/docs/phil/works/Two Dogmas of Empiricism.html) | 
...
[^ri]:  We need inferential transitions that have authority. These are not the same as premises, c.f. [What the Tortoise said to Achilles](/docs/phil/works/What the Tortoise said to Achilles.html).
...
Holism at the level of semantics (the *meaning* of one of these privileged representations cannot be independent of other representations). And holism at the level of [semantics and epistemology](/docs/phil/interaction/Semantics and epistemology.html) (the *meaning* of one of these privileged representations cannot be independent of which ones we are committed to).
...
[^witt]: [Agreement on meanings requires agreement of judgments](/docs/phil/quotes/Agreement on meanings requires agreement of judgments.html)


## Holism of Sellars and Quine

- Sellars in [EPM](/docs/phil/works/Empiricism and the Philosophy of Mind.html)
  - [Locke](/docs/phil/people/John Locke.html) got confused by conflating the causation of a belief from its justification. See [Reasons vs causes](/docs/phil/interaction/Reasons vs causes.html) distinction.
...
- Quine in [Two Dogmas of Empiricism](/docs/phil/works/Two Dogmas of Empiricism.html)
...
- [Fodor](/docs/phil/people/Jerry Fodor.html) argues against this, considers mixing epistemology and semantics to be a big philosophical mistake initiated by Quine.
...
- So Rorty and [Price](/docs/phil/people/Huw Price.html) need to do one or both of:
