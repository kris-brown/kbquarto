...
listing:
  ...
  contents:
    - ../../../backlinks/26. evolutionary ethics.yml
---

[Elucidations](/docs/phil/elucidations/Elucidations.html): [Prev](/docs/phil/elucidations/25. Coversational context.html) Next
  ...
  - Human altruism is also an effect that is amplified for kin
    ...
    - You see a burning building and a person inside it
      ...
      - It's your neighbor - you call the fire department (societally judged as 
        moral behavior)
      - This is very distinct from [Kantian](/docs/phil/people/Immanuel Kant.html) 
