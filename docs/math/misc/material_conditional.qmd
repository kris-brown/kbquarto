...
- The symbol $\implies$ is read as `implies' and is also called the \href{https://en.wikipedia.org/wiki/Material_conditional}{material conditional}.
...
- Its *meaning*, in brief, is an assertion that $Q$ being true can be asserted if $P$ is true.
    -  There is a gap between these two characterizations, expressed in Lewis Carroll's [parable](/docs/phil/problems/tortoise.qmd).
