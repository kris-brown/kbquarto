...
- Can't we explain why a particular bee on one occasion does that by invoking 
  the pattern that it's an instance of?
    ...
    - This is related to distinction of pattern-governed vs rule-obeying 
      ...
      career to this, developing the field of [teleosemantics](/docs/phil/Teleosemantics.html)and writing about 
      it in [Language, Thought, and Other Biological Categories](/docs/phil/works/Language, Thought, and Other Biological Categories.html).
