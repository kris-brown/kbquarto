...
Introduced in [*Empiricism and the Philosophy of Mind*](/docs/phil/people/sellars/works/epm) (9 years earlier), distinct 
...
E.g. [sour acid](/docs/phil/situations/souracid.qmd) and 
[witch](/docs/phil/situations/witches.qmd) examples.
...
##  Digressions
1. [*Semantics*](/docs/phil/definitions/semantics.qmd) is a field with instrumentalist vs theoretical realist views. 
[Michael Dummett](/docs/phil/people/dummett) is an instrumentalist 
...
2. [MacDowell](/docs/phil/people/macdowell) and Sellars agree 
...
[Kripkenstein](/docs/phil/people/kripke/works/kripkenstein). In present 
...
[Grice](/docs/phil/people/grice) on non-natural meaning: reduces what 
...
[Ruth Millikan](/docs/phil/people/millikan)'s work relevant. 
Connects to the [Aristotelian](/docs/phil/people/aristotle) account.
...
People with romantic views of language: [Derrida](/docs/phil/people/derrida) 
and [Nietzsche](/docs/phil/people/nietzsche). These are compatible 
with Wittgenstein [believing language has no downtown](/docs/phil/people/wittgenstein#downtown).
...
[social status](/docs/phil/people/brandom#sapience).
