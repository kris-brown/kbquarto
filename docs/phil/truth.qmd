...
The former is a modern, representationalist rendering of [Aristotle](/docs/phil/people/Aristotle.html)'s "saying of what is, that it is, and of what is not, that it is not". The latter is associated with [James](/docs/phil/people/William James.html) and Rorty sees no conflict between the two (because the former is a [platitude](/docs/phil/quotes/Truth not interesting.html)). 

Pragmatists see philosophy's lack of success in convincingly finding a non-platitudinous way of making sense of the first conception, and thus we should move on and [change the subject](/docs/phil/quotes/Changing the subject.html). They deny truth has an [essence](/docs/phil/quotes/Pragmatism as anti-essentialism.html).[^ec]
