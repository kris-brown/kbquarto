...
— [Inference and Meaning](/docs/phil/works/Inference and Meaning.html) Section 5

- Related to [this quote](/docs/phil/quotes/Describing without modality.html).
...
- [Carnap](/docs/phil/people/Rudolf Carnap.html) uses 'transposed' to talk about an unquoted word used in a sentence as a
