...
> In characterizing an episode or a state as *knowing*, we are not giving an
 ...
 — [Empiricism and the Philosophy of Mind](/docs/phil/Empiricism and the Philosophy of Mind.html) §36
...
- Relates to the [Scienta mensura](/docs/phil/Scienta mensura.html) quote - we have an example of something 
