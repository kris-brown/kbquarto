...
- \begin{tikzcd}                                                                            &                                                                                &                                    & v\arrow[blue,r, "d"'] \arrow[green,dd, "c"] & w \arrow[rd, "h"] \arrow[green,dd,"g"'] &   \\1 \arrow[r, "f"] \arrow[blue,rrru, dashed, bend left] \arrow[red,rrrd,dashed, bend right] & 2 \arrow[blue,rrru, "F"', dashed, bend left=49]\arrow[red,rrrd, "G", dashed, bend right=49] & u \arrow[ru, "a"]\arrow[rd, "b"'] &                                  &                                    & z \\                                                                                &                                                                                    &                                    & x\arrow[red,r, "e"]                  & y \arrow[ru,"k"']                 &  \end{tikzcd}
...
-  Just like sets are in bijection with [functors](#functor) $\mathbf{1}\rightarrow\mathbf{Set}$, we can also associate [natural transformations](#nattrans) \begin{tikzcd}1 \arrow[r, bend left] \arrow[r, "\Downarrow", bend right] & Set\end{tikzcd} with functions.
...
2. Counterexample: \begin{tikzcd}\underline{\mathcal{C}}&\underline{\mathcal{P}}\\2&b\\1 \arrow[u, "x", bend left] \arrow[u, "y"', bend right] &a \arrow[u, "f"]\end{tikzcd}
...
- The objects of **GrInst** are graphs, the morphisms are *graph homomorphisms* ([natural transformations](#nattrans) between two **Gr** to **Set** [functors](#functor))
    ...
    - Naturality conditions
        1. \begin{tikzcd}G(Arr) \arrow[r, "\alpha_{Arr}"] \arrow[d, "G(src)"'] & H(Arr) \arrow[d, "H(src)"] \\G(Vert) \arrow[r, "\alpha_{Vert}"']                   & H(Vert)                   \end{tikzcd}
        2. \begin{tikzcd}G(Arr) \arrow[r, "\alpha_{Arr}"] \arrow[d, "G(tar)"'] & H(Arr) \arrow[d, "H(tar)"] \\G(Vert) \arrow[r, "\alpha_{Vert}"']                   & H(Vert)                   \end{tikzcd}
