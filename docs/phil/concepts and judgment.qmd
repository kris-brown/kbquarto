...
However, [Kant](/docs/phil/Immanuel Kant.html) turned this around. In this view, judgments are prior (in the order of understanding) to concepts.
...
inferences [material_inferences](/docs/phil/Material inference vs logical inference.html) and 
...
However, [What the Tortoise said to Achilles](/docs/phil/What the Tortoise said to Achilles.html)  articulates that, although the logically-valid inferences exist *a priori* as abstract mathematical/syntactical objects, without having any 
