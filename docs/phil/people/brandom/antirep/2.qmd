...
- Struggle between two camps in the 19th century, which is then re-enacted in 
  ...
  - Neokantianism (Marburg / Freiburg to CI Lewis and Carnap). Philosophy has 
    sovereign authority.
    - Idea originates with [Plato](/docs/phil/people/plato), but 
      Descartes/Kant/representationalism are 
      modern versions.
  - Neohegelianism ([Hegel](/docs/phil/people/hegel) socialized 
    philosophy, Marx naturalized it). 
    Philosophy brought 'down to Earth'.
- [Bertrand Russell](/docs/phil/people/russell) and 
  [Husserl](/docs/phil/people/hussurl) found things for 
  ...
  - Husserl subject to Sellars' critique of the 
    ...
    [Russell](/docs/phil/people/russell) 
    subject to [Quine](/docs/phil/people/quine)'s critique of the
    [Myth of the Museum](/docs/phil/people/quine/myth.qmd). 
    ([Carnap](/docs/phil/people/carnap) is subject to both myths).
    - These are both (semantic) holist arguments.
- Rorty regards the pragmatist/holist Quine+Sellars rebuttals as bringing us 
  back to [Dewey](/docs/phil/people/dewey)'s 
...
- common origin: role as infinite regress stoppers for the two types of 
  ...
  - [Agrippan trilema](/docs/phil/problems/regress/agrippan.qmd) of alternatives to 
    skepticism
...
- Sellars in [EPM](/docs/phil/people/sellars/works/epm) 
  - [Locke](/docs/phil/people/locke) got confused by conflating the 
  ...
  - Sense data may be causally prerequisite to knowledge, but it cannot justify 
    ...
    - How do we acquire knowledge in the semantic holist POV?
      - How to get into the game of giving and asking for reasons? "The light 
        ...
        'competent speaker'.
- Quine in [TDE](/docs/phil/people/quine/works/two_dogmas) 
...
- The unit of meaning must be the web-of-belief rather than the concept or the 
  sentence.
- [Fodor](/docs/phil/people/fodor) argues against this, considers 
...
- "Default and challenge" structure a way of avoiding 
  [Agrippan trilemma](/docs/phil/problems/regress/agrippan.qmd).
...
- So Rorty and [Price](/docs/phil/people/price) need to do one or 
  both of:
  1. Argue independently for [pragmatism](/docs/phil/schools/pragmatism.qmd), 
