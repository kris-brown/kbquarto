---
title: 04 - Counterfactuals and the Kant-Sellars Thesis (2009)
tags: 
 - lecture
 - RED
...
listing:
  ...
  contents:
    - ../../../backlinks/04 - counterfactuals and the kant-sellars thesis (2009).yml
---

[Author](/docs/phil/people/Robert Brandom.html) [Prev](/docs/phil/sellars2009/03 - Language as thought and different species of ought (2009).html)

# Counterfactuals and dispositions

Uses [Principia Mathematica](/docs/phil/works/Principia Mathematica.html) 
notation, which takes some time to learn.

[Goodman](/docs/phil/people/Nelson Goodman.html) has let the formalism of classical 
...
Goodman is impressed in [Fact, Fiction, and Forecast](/docs/phil/works/Fact, Fiction, and Forecast.html), with 
...
Sellars makes the distinction of [subjunctive vs counterfactual conditionals](/docs/phil/Subjunctive vs counterfactual conditionals.html).
...
An axial idea of [Immanuel Kant](/docs/phil/people/Immanuel Kant.html): the framework that 
...
[Immanuel Kant](/docs/phil/people/Immanuel Kant.html) is concerned with features that are 
...
[Semantic nominalism](/docs/phil/Semantic nominalism.html) was universally held until Kant. (philosophy today hasn't 
...
{{< include "/docs/phil/quotes/labels vs descriptions.qmd" >}}
...
thought about it. Related to Wittgenstein's [plate example](/docs/phil/Pointing at a plate.html).

[Immanuel Kant](/docs/phil/people/Immanuel Kant.html) says concepts are rules for judgment we 
[bind ourselves by](/docs/phil/people/Robert Brandom.html#concepts). That doesn't settle the question of how much of the law we need to know in order to bind ourselves by it. I don't have to know much about molybdenum to refer to molybdenum.
...
Sellars calls this [descriptivism](/docs/phil/Descriptivism.html): what you do with language is describe things.

You find this not only in anglophone tradition but also in a pure form in 
Hussurl / semiotics. [Derrida](/docs/phil/people/Jaques Derrida.html) rejects Hussurl because there are 
...
things with them. Theory of judgment. The [Tractatus Logico-Philosophicus](/docs/phil/works/Tractatus Logico-Philosophicus.html) has no 
room for statements of natural law. For normative statements, it retreats into mysticism.

[Semantic nominalism](/docs/phil/Semantic nominalism.html) is atomistic - the relation of a name and its bearer 
doesn't turn on anything else.

# Kant-Sellars thesis

{{< include "/docs/phil/kant-sellars thesis.qmd" >}}

# Modal revolution in the 20th century
Revolution in Anglophone philosophy, taking three phases:

1. Kripke's  [possible worlds semantics](/docs/phil/Possible worlds semantics.html)  for modal logic (algebraic properties 
...
2. The previous development is only for modal logic, but Montague, David Kaplan, 
   [David Lewis](/docs/phil/people/David Lewis.html), Stalnaker, etc. extended 
   it to work for non-logical semantics as well. See, for example, Lewis' [General Semantics](/docs/phil/works/General Semantics.html)
3. Kripke's [Naming and Necessity](/docs/phil/works/Naming and Necessity.html)
...
comfortablity with alethic modal language is actually the [Kant-Sellars thesis](/docs/phil/Kant-Sellars thesis.html), 
...
[Frege-Geach argument](/docs/phil/Frege-Geach argument.html) in terms of what one is *doing* when we use the expressions.)
...
In Brandom's view, [material inferences](/docs/phil/interaction/Material inference vs logical inference.html) are [not monotonic](/docs/phil/Nonmonotonic logic.html). The job of some 
...
# Relation to Hegel
[Hegel](/docs/phil/people/Georg Wilhelm Friedrich Hegel.html) says, "By conceptual, I mean, what's articulated by relations of 
...
[Phenomenology of Spirit](/docs/phil/works/Phenomenology of Spirit.html).
...
[David Lewis](/docs/phil/people/David Lewis.html) is presented as an example of 
