...
$B \xrightarrow{\iota_2,\ !} X$ is the same as $g$). 
...
side-by-side. With [Catlab.jl](/https://algebraicjulia.github.io/Catlab.jl/latest/),
...
[^1]: In many ways it's more like plumbing than magic, as David Spivak puts it.
...
Let's consider a concrete example from graphs. Let's say we wanted to recover 
...
are there from $G$ into $T$?" for *any* other graph $G$.  It turns out, no 
...
tries to talk about things (being $T$, being the "sum" of two other things) 
