...
— [Philosophy and the Scientific Image of Man](/docs/phil/works/Philosophy and the Scientific Image of Man.html)
...
- The idea of language as something that is necessarily (rather than 
  accidentally) criticizable is close to the [private language argument](/docs/phil/works/Philosophical Investigations.html).
