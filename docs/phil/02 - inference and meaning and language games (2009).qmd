...
---
[Author](/docs/phil/Robert Brandom.html) [Prev](/docs/phil/01 - Historical context and quotes (2009).html) [Next](/docs/phil/03 - Language as thought and different species of ought (2009).html)
...
# [Material inferences](/docs/phil/Material inference vs logical inference.html)

{{< include "Material inference vs logical inference.qmd" >}}
...
[Dummett](/docs/phil/Michael Dummett.html) has written about this issue.
...
- Talking about following rules very quickly gets into the [regress of rules](/docs/phil/Regress of rules.html).
    - There have to be some practical moves you're just allowed to make without 
      ...
      [What the Tortoise said to Achilles](/docs/phil/What the Tortoise said to Achilles.html).
    - Sellars touches upon this in [Some reflections on language games](/docs/phil/Some reflections on language games.html).
...
- "Red is a quality". This conveys the same information as the syntactical 
  ...
  [quote](/docs/phil/Transposed language of norms.html). What you're *doing* in asserting 
