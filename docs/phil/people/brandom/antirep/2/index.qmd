---
title: "02: Rorty’s Critique of Enlightenment Representationalism, and (so) of Analytic Philosophy"
---
...
- Struggle between two camps in the 19th century, which is then re-enacted in 
  ...
  - Neokantianism (Marburg / Freiburg to CI Lewis and Carnap). Philosophy has 
    sovereign authority.
    - Idea originates with [Plato](/docs/phil/people/plato/index.qmd), but Descartes/Kant/representationalism are 
      modern versions.
  - Neohegelianism (Hegel socialized philosophy, Marx naturalized it). 
    Philosophy brought 'down to Earth'.
- Bertrand Russell and Husserl found things for philosophy to be apodictic 
  ...
  - Husserl subject to Sellars' critique of the Myth of the Given, Russell 
    subject to Quine's critique of Myth of the Museum. (Carnap subject to both).
    - "Uncritical semantics is the myth of a museum in which the exhibits are 
      ...
      labels". Against the museum myth, Quine argues here  for the indeterminacy 
...
- Rorty regards the pragmatist/holist Quine+Sellars rebuttals as bringing us 
  back to Dewey's socialized/historicized/naturalized philosophy, with the 20th 
...
- common origin: role as infinite regress stoppers for the two types of 
  ...
  - [Agrippan trilema](/docs/phil/problems/agrippan.qmd) of alternatives to 
    ...
    - justification always in reference to other claims which require 
      justification (this can be circular or [infinite regress](/docs/phil/problems/ruleregress.qmd)) 
    ...
    - If we have foundations, we need two kinds of regress stoppers:
      ...
      - inferential transitions that have authority
        - These are not the same as premises, c.f. [Tortoise and the Hare](/docs/phil/problems/tortoise.qmd)
...
- Sellars in EPM [-@sellars1956empiricism]
  - Locke got confused by conflating the causation of a belief from its 
    justification.
...
- Quine in TDE [-@orman1976two]
  ...
  - Duhem-Quine thesis: "it is impossible to test a scientific hypothesis in 
...
- The unit of meaning must be the web-of-belief rather than the concept or the 
  sentence.
- Fodor argues against this, considers mixing epistemology and semantics to be a 
...
- So Rorty and Pryce need to do one or both of:
  1. Argue independently for pragmatism, then use that to attack 
