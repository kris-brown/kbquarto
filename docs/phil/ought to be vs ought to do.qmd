...
listing:
  ...
  contents:
    - ../../backlinks/ought to be vs ought to do.yml
---
...
- A distinction fundamental for both 'must' in the [alethic](/docs/phil/Alethic modality.html) and  [doxastic](/docs/phil/Doxastic modality.html) modal senses.

- [Sellars](/docs/phil/people/Wilfrid Sellars.html): You can't understand either of these kinds of oughts without 
...
- This is important because natural way to think of rules is exlusively in terms 
  of Ought to Do (Sellars himself advocated this [earlier](/docs/phil/works/Some reflections on language games.html): "A rule is always a  rule for doing something").
...
## Upshots
This lets us avoid the [rule obeying regress](/docs/phil/Regress of rules.html).
