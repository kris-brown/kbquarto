...
listing:
  ...
  contents:
    - ../../../backlinks/concepts and judgment.yml
---

# Overview 

We normally think that the content of judgments are dictated by the content of the [concepts](/docs/phil/Concepts.html) used inside of them. This feels especially right for artificial languages:
...
However, [Kant](/docs/phil/people/Immanuel Kant.html) turned this around. In this view, judgments are prior (in the order of understanding) to concepts.
...
inferences [material_inferences](/docs/phil/interaction/Material inference vs logical inference.html) and 
...
However, [What the Tortoise said to Achilles](/docs/phil/works/What the Tortoise said to Achilles.html)  articulates that, although the logically-valid inferences exist *a priori* as abstract mathematical/syntactical objects, without having any 
