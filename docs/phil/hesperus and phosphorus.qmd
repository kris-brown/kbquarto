...
These are puzzles posed by [Frege](/docs/phil/Gottlob Frege.html). They are addressed
by making a [distinction between sense and reference](/docs/phil/Sense vs reference.html).
...
[semantics](/docs/phil/Semantics.html) (attributed to [Mill](/docs/phil/John Stuart Mill.html)), names have no meaning beyond their reference, meaning the second sentence *means* "Venus is Venus".
