...
temptation of the [empiricist](/docs/phil/Empiricism.html) tradition.

The alternative is called *theoretical realism*. Sellars says this is a mistake 
(an example of "nothing-but-ism", along with [emotivism](/docs/phil/Emotivism.html) in ethics), originating 
...
[Pluto](/docs/phil/Pluto.html) example.
