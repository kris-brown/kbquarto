...
listing:
  ...
  contents:
    - ../../../../backlinks/docs/phil/problems/regress/representation.yml
---

If any things are known 
[representationally](/docs/phil/definitions/representation.qmd),
then some things must be known 
nonrepresentationally (immediately, by being *had* or *grasped*).

- Otherwise we can't know about something via a representation $R$, because we'd 
  need another representation to know $R$.
- Representationalism gives rise to 
  [choice](/docs/phil/problems/regress/agrippan.qmd) between [epistemological 
  skepticism](/docs/phil/problems/skepticism/epistemological.qmd) vs 
  foundationalism.
...
[semantic skepticism](/docs/phil/problems/skepticism/semantic.qmd): skepticism 
about the intelligibility of the very notion of knowledge, the intelligibility 
of the notion of a representational relation between what's known and the 
knowing of it.