---
title: 01 - Historical context and quotes (2009)
tags: 
- lecture
- YELLOW
...
listing:
  ...
  contents:
    - ../../../backlinks/01 - historical context and quotes (2009).yml
---

[Author](/docs/phil/people/Robert Brandom.html) [Next](/docs/phil/sellars2009/02 - Inference and Meaning and Language Games (2009).html)
...
- Sellars' overall aim was to move analytic philosophy from its Humean phase to its Kantian phase.
  ...
  - That Kant was worth respecting a radical view at the time - he had been 
    written out of the canon due to his connection to [Hegel](/docs/phil/people/Georg Wilhelm Friedrich Hegel.html).
...
by the later Wittgenstein - for example his [children's game](/docs/phil/A children's game.html) investigates the 
...
- Things like intentional, normative, metaphysical vocabularies were typically 
  ...
  - Core programs of empiricism and naturalism can be understood as having 
    ...
    - Naturalism: language of natural science (possibly just fundamental 
      physics or broader)
    - The Vienna Circle was divided into two wings. Schlict (empiricist) and [Otto Neurath](/docs/phil/people/Otto Neurath.html) 
...
{{< include "/docs/phil/quotes/space of reasons.qmd" >}}
...
[Counterfactuals, Dispositions, and the Causal Modalities](/docs/phil/works/Counterfactuals, Dispositions, and the Causal Modalities.html).
...
- E.g. "Looks $\phi$" talk depends on "Is $\phi$" talk. ([EPM](/docs/phil/works/Empiricism and the Philosophy of Mind.html))
...
- the empricial naturalism is epitomized by [Scienta mensura](/docs/phil/quotes/Scienta mensura.html) quote
