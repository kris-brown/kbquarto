...
[Elucidations](/docs/phil/Elucidations.html): [Prev](/docs/phil/13. Judgment aggregation.html) [Next](/docs/phil/15. Religious toleration.html)
...
# What is radical skepticism advocating?
  ...
  - Many different skeptical arguments, often of the form "There exists a 
    ...
    - Examples: dreaming, [evil genius](/docs/phil/René Descartes.html), 
      [brain in a vat](/docs/phil/Epistemological skepticism.html) (from [Putnam](/docs/phil/Hilary Putnam.html))
...
## [No reason to believe brains in vats can think](/docs/phil/Brain states and experience.html) 
...
Drawing from thoughts of [John MacDowell](/docs/phil/John MacDowell.html)'s [Mind and World](/docs/phil/Mind and World.html):
...
- [Stanley Cavell](/docs/phil/Stanley Cavell.html) has written well about  how skeptical lines of thought arise
