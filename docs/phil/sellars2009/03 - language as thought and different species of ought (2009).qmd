---
title: 03 - Language as thought and different species of ought (2009)
tags: 
 - lecture
 - RED
...
listing:
  ...
  contents:
    - ../../../backlinks/03 - language as thought and different species of ought (2009).yml
---

[Author](/docs/phil/people/Robert Brandom.html) [Prev](/docs/phil/sellars2009/02 - Inference and Meaning and Language Games (2009).html) [Next](/docs/phil/sellars2009/04 - Counterfactuals and the Kant-Sellars Thesis (2009).html)
...
Introduced in [Empiricism and the Philosophy of Mind](/docs/phil/works/Empiricism and the Philosophy of Mind.html) (9 years earlier), distinct 
...
[instrumentalism](/docs/phil/Instrumentalism.html) in the philosophy of science.
...
E.g. [sour acid](/docs/phil/Sour acid.html) and 
[referring to witches](/docs/phil/Referring to witches.html) examples.
...
[Pluto](/docs/phil/Pluto.html) is a great counterexample for this 
distinction.
...
##  Digressions
1. [Semantics](/docs/phil/Semantics.html) is a field with instrumentalist vs theoretical realist views. 
[Michael Dummett](/docs/phil/people/Michael Dummett.html) is an instrumentalist 
...
1. [MacDowell](/docs/phil/people/John MacDowell.html) and Sellars agree 
...
Reminder that, due to the [regress argument](/docs/phil/Regress of rules.html), 
...
[Grice](/docs/phil/people/Paul Grice.html) on non-natural meaning: reduces what 
...
Connects to the [Aristotelian](/docs/phil/people/Aristotle.html) account.
...
# [Instrumentalism](/docs/phil/Instrumentalism.html)
{{< include "/docs/phil/instrumentalism.qmd" >}}

# Ought to be and ought to do

See distinction: [Ought to be vs ought to do](/docs/phil/Ought to be vs ought to do.html)

# Sense vs reference dependence

See distinction [Sense dependence vs reference](/docs/phil/interaction/Sense dependence vs reference.html)

# Romantic views of language
People with romantic views of language: [Derrida](/docs/phil/people/Jaques Derrida.html) and [Nietzsche](/docs/phil/people/Frederich Nietzsche.html). These are compatible 
with Wittgenstein [believing language has no downtown](/docs/phil/people/Ludwig Wittgenstein.html).
...
[social status](/docs/phil/people/Robert Brandom.html#sapience).
...
as talking if you can (note this is a [very high bar](/docs/phil/Novel sentences.html).
...
[Auction](/docs/phil/Auction.html) example. That's the sort of position that the kid (who's just crossed the line into being able to say something) is: she can produce a vocalization that will hold her responsible 
