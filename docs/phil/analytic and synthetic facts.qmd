...
It is broken in Quine's [Two Dogmas of Empiricism](/docs/phil/Two Dogmas of Empiricism.html).
...
Quine's target is [Carnap](/docs/phil/Rudolf Carnap.html) (who is thinking of artificial languages: first you fix the language, and then you go into the world to see which are true in virtue of what they mean).
