...
listing:
  ...
  contents:
    - ../../../backlinks/2. poetry.yml
---

[Elucidations](/docs/phil/elucidations/Elucidations.html): [Prev](/docs/phil/elucidations/1. Desire.html) [Next](/docs/phil/elucidations/3. Nietzsche and Morality.html)

# What do we mean by poetry
- Clarification: "poetry" to [Plato](/docs/phil/people/Plato.html) is more similar to what we call theatre
...
- The effect of being exposed to poetry: one tries to be many things, instead of 
  one thing.
  - Background: Plato + [Aristotle](/docs/phil/people/Aristotle.html) 
