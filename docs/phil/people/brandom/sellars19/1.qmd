...
This is something Kant shares with later Wittgenstein (e.g. 
[children's game](/docs/phil/situations/childrensgame.qmd)).
...
[not the *concept*](/docs/phil/switcharoos/concept_judgment.qmd). 
...
- Kant turned this around to distinguish *constraint by norms* from 
  *constraint by power*.
- Discussed in [Some Reflections on Language Games](/docs/phil/people/sellars/works/some_reflections).
...
- Trying to *describe* the modal structure of the world or describe the 
  ...
  [descriptivism](/docs/phil/schools/descriptivism.qmd), rather than seeing 
  them as playing a different expressive role
- Sellars saw Kant as putting this other option on the table.

## [Distinction between *phenomena* and *noumena*](/docs/phil/distinctions/made/noumena_phenomena.qmd) 
