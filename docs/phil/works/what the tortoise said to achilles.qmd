...
listing:
  ...
  contents:
    - ../../../backlinks/what the tortoise said to achilles.yml
---
...
- The Tortoise assumes a proposition $p$ and a [material conditional](/docs/phil/Material Conditional.html) $p \implies q$.
