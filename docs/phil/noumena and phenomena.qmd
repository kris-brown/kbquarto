...
In the eyes of Hegel/Sellars/Brandom, [Kant](/docs/phil/Immanuel Kant.html) is interpreted as having radicalized the distinction between:
...
This distinction lives in [Sellars](/docs/phil/Wilfrid Sellars.html) as the difference between:
