...
[Author](/docs/phil/Robert Brandom.html) [Prev](/docs/phil/03 - Language as thought and different species of ought (2009).html)

# Counterfactuals and dispositions

Uses [Principia Mathematica](/docs/phil/Principia Mathematica.html) 
notation, which takes some time to learn.

[Goodman](/docs/phil/Nelson Goodman.html) has let the formalism of classical 
...
Goodman is impressed in [Fact, Fiction, and Forecast](/docs/phil/Fact, Fiction, and Forecast.html), with 
...
An axial idea of [Immanuel Kant](/docs/phil/Immanuel Kant.html): the framework that 
...
[Immanuel Kant](/docs/phil/Immanuel Kant.html) is concerned with features that are 
...
{{< include "Labels vs descriptions.qmd" >}}
...
[Immanuel Kant](/docs/phil/Immanuel Kant.html) says concepts are rules for judgment we 
[bind ourselves by](/docs/phil/Robert Brandom.html#concepts). That doesn't settle the question of how much of the law we need to know in order to bind ourselves by it. I don't have to know much about molybdenum to refer to molybdenum.
...
Hussurl / semiotics. [Derrida](/docs/phil/Jaques Derrida.html) rejects Hussurl because there are 
...
things with them. Theory of judgment. The [Tractatus Logico-Philosophicus](/docs/phil/Tractatus Logico-Philosophicus.html) has no 
...
{{< include "Kant-Sellars thesis.qmd" >}}
...
2. The previous development is only for modal logic, but Montague, David Kaplan, 
   [David Lewis](/docs/phil/David Lewis.html), Stalnaker, etc. extended 
   it to work for non-logical semantics as well. See, for example, Lewis' [General Semantics](/docs/phil/General Semantics.html)
3. Kripke's [Naming and Necessity](/docs/phil/Naming and Necessity.html)
...
[quote](/docs/phil/Transposed language of norms.html).
...
In Brandom's view, [material inferences](/docs/phil/Material inference vs logical inference.html) are [not monotonic](/docs/phil/Nonmonotonic logic.html). The job of some 
...
# Relation to Hegel
[Hegel](/docs/phil/Georg Wilhelm Friedrich Hegel.html) says, "By conceptual, I mean, what's articulated by relations of 
...
[Phenomenology of Spirit](/docs/phil/Phenomenology of Spirit.html).
...
[David Lewis](/docs/phil/David Lewis.html) is presented as an example of 
