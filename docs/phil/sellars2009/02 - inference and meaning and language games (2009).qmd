---
title: 02 - Inference and Meaning and Language Games (2009)
tags: 
 - lecture
 - RED
...
listing:
  ...
  contents:
    - ../../../backlinks/02 - inference and meaning and language games (2009).yml
---
[Author](/docs/phil/people/Robert Brandom.html) [Prev](/docs/phil/sellars2009/01 - Historical context and quotes (2009).html) [Next](/docs/phil/sellars2009/03 - Language as thought and different species of ought (2009).html)
...
# [Material inferences](/docs/phil/interaction/Material inference vs logical inference.html)

{{< include "/docs/phil/interaction/material inference vs logical inference.qmd" >}}
...
[Dummett](/docs/phil/people/Michael Dummett.html) has written about this issue.
...
- The [Montaigne example](/docs/phil/Montaigne's dog.html) highlights 
...
- Talking about following rules very quickly gets into the [regress of rules](/docs/phil/Regress of rules.html).
    - There have to be some practical moves you're just allowed to make without 
      ...
      [What the Tortoise said to Achilles](/docs/phil/works/What the Tortoise said to Achilles.html).
    - Sellars touches upon this in [Some reflections on language games](/docs/phil/works/Some reflections on language games.html).
...
- "Red is a quality". This conveys the same information as the syntactical 
  ...
  [quote](/docs/phil/quotes/Transposed language of norms.html). What you're *doing* in asserting 
...
[^inf]: However, Sellars doesn't extrapolate from this that logic is an *optional* 
...
sequence). This is also called '[disjunctivitis](/docs/phil/Disjunctivitis.html)' or 'gerrymandering' objections.
...
- So what's needed he's saying, is going to be something that says, look, 
  ...
  this is teleosemantics. See [Bee Waggle](/docs/phil/Bee Waggle.html).
...
Related quesiton addressed here: [classical behaviorism](/docs/phil/Behaviorism.html).
