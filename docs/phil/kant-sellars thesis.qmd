...
listing:
  ...
  contents:
    - ../../backlinks/kant-sellars thesis.yml
---

From three premises:

1. what you need to move from [Labeling](/docs/phil/Labeling.html) to describing is situation in a space of 
   implications
...
It's explicit in [Sellars](/docs/phil/people/Wilfrid Sellars.html), all but explicit in [Kant](/docs/phil/people/Immanuel Kant.html). Some consequences:

- [modal](/docs/phil/Modality.html) vocabulary is not something that you can casually add to [ordinary descriptive vocabulary](/docs/phil/Ordinary descriptive vocabulary.html), like culinary vocabulary. Rather, the distinctive 
